...
export function FamilyDashboard({ familyId }: FamilyDashboardProps) {
      ...
      .on(
        ...
        (payload) => {
          ...
          setData((prev) => ({
            ...prev,
            recentAnalyses: [
              payload.new as SocialHealthAnalysis,
              ...prev.recentAnalyses,
            ].slice(0, 50),
          }));
        }
  ...
  const chartData = selectedChildAnalyses.reverse().map((analysis) => ({
        ...
        <div className="max-w-[1400px] mx-auto space-y-8">
          ...
          <div className="text-center space-y-4">
            ...
            <p
              ...
              style={{ fontFamily: "var(--font-inter)" }}
            >
              Building trust through understanding - your family's digital
              wellness insights
            </p>
          </div>
          ...
          {data.activeAlerts.length > 0 && (
            <Card className="border-orange-200 bg-orange-50">
              <CardHeader>
                ...
                <CardDescription>
                  These insights suggest opportunities for supportive family
                  conversations
                </CardDescription>
              </CardHeader>
              <CardContent>
          ...
          <div className="flex gap-4 overflow-x-auto pb-2">
            {data.children.map((child) => {
              const latestAnalysis = data.recentAnalyses.find(
                ...
                <Card className="bg-gradient-to-br from-blue-50 to-blue-100 border-blue-200">
                  ...
                  <CardContent>
                    ...
                    <p
                      ...
                      style={{ fontFamily: "var(--font-inter)" }}
                    >
                      {selectedChildAnalyses[0]?.emotional_state ||
                        "No recent data"}
                    </p>
                  </CardContent>
                </Card>
                  ...
                  <CardContent>
                    ...
                    >
                      {selectedChildAnalyses.length >= 2
                        ? selectedChildAnalyses[0]?.mood_score >
                          selectedChildAnalyses[1]?.mood_score
                          ? "↗️"
                          : "↘️"
                        : "➡️"}
                    </div>
                  ...
                  <CardContent>
                    ...
                    >
                      {selectedChildAnalyses[0]
                        ? new Date(
                            selectedChildAnalyses[0].analysis_date
                          ).toLocaleDateString()
                        : "Never"}
                    </div>
                    <p
              ...
              {chartData.length > 0 && (
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      Understanding emotional and social patterns to guide
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      Understanding patterns to guide supportive conversations
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
                    {selectedChildAnalyses[0] ? (
                      <div className="space-y-4">
                        <div>
                          ...
                          <ul
                            ...
                            style={{ fontFamily: "var(--font-inter)" }}
                          >
                            {selectedChildAnalyses[0].ai_insights?.positive_indicators?.map(
                        ...
                        <div>
                          ...
                          <ul
                            ...
                            style={{ fontFamily: "var(--font-inter)" }}
                          >
                            {selectedChildAnalyses[0].ai_insights?.concerns?.map(
                ...
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      Research-backed approaches for meaningful dialogue
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
                    {selectedChildAnalyses[0]?.intervention_recommendations
                      ?.length ? (
                      <div className="space-y-3">
                        {selectedChildAnalyses[0].intervention_recommendations
                          .slice(0, 3)
                          .map((recommendation: string, index: number) => (
                            <div
                              key={index}
                              className="p-3 bg-gradient-to-r from-blue-50 to-green-50 rounded-lg border-l-4 border-blue-400"
                            >
                              <p
                                className="text-sm"
                                style={{ fontFamily: "var(--font-inter)" }}
