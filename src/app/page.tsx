...
import { ArrowRight, MessageCircle, Brain, Heart, TrendingUp, Users, Star, Lock, Award, Shield } from 'lucide-react'
    ...
    <div className="min-h-screen bg-white overflow-hidden">
      ...
      <header className="bg-gradient-to-r from-purple-600 to-blue-600 sticky top-0 z-50 backdrop-blur-lg">
        <nav className="max-w-[1400px] mx-auto flex justify-between items-center py-4 px-6">
          <Link href="/" className="flex items-center space-x-3 text-white text-xl font-semibold">
            ...
            <span style={{ fontFamily: 'var(--font-poppins)' }}>Heart Harbor</span>
          </Link>
          
          <div className="hidden md:flex items-center space-x-8">
            <Link href="#how-it-works" className="text-white hover:opacity-80 transition-opacity font-medium">
              How It Works
            </Link>
            <Link href="#pricing" className="text-white hover:opacity-80 transition-opacity font-medium">
              Pricing
            </Link>
            <Link href="/auth/login" className="text-white hover:opacity-80 transition-opacity font-medium">
              Sign In
            </Link>
          </div>
      ...
      <section className="relative min-h-screen bg-gradient-to-br from-purple-50 to-blue-50 flex items-center overflow-hidden">
        ...
        <div className="max-w-[1400px] mx-auto px-6 py-16 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center relative z-10">
          ...
          <div className="space-y-8">
            ...
            <p className="text-xl text-gray-600 max-w-lg" style={{ fontFamily: 'var(--font-inter)' }}>
              AI-powered emotional support that helps your family build better communication, 
              providing insights into conversation patterns and emotional growth.
            </p>
                ...
                <div className="w-full h-full bg-white rounded-2xl p-6 flex flex-direction-column justify-start">
                  <div className="space-y-4">
                    ...
                    <div className="flex items-center gap-3 pb-4 border-b border-gray-100">
                      ...
                      <div>
                        <p className="font-semibold text-gray-800">Dr. Emma AI</p>
                    ...
                    <div className="bg-orange-50 border border-orange-200 rounded-lg p-3 text-xs">
                      <div className="flex items-center gap-2 mb-2">
                        ...
                        <span className="font-medium text-orange-700">Mood Analysis</span>
                      </div>
        ...
        <div className="max-w-[1400px] mx-auto px-6">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-8 text-center">
            <div className="space-y-4">
              ...
              <h3 className="font-semibold text-lg" style={{ fontFamily: 'var(--font-poppins)' }}>Family Safe AI</h3>
            ...
            <div className="space-y-4">
              ...
              <h3 className="font-semibold text-lg" style={{ fontFamily: 'var(--font-poppins)' }}>5,000+ Families</h3>
              <p className="text-gray-600 text-sm" style={{ fontFamily: 'var(--font-inter)' }}>
            ...
            <div className="space-y-4">
              ...
              <h3 className="font-semibold text-lg" style={{ fontFamily: 'var(--font-poppins)' }}>Expert AI Coach</h3>
              <p className="text-gray-600 text-sm" style={{ fontFamily: 'var(--font-inter)' }}>
            ...
            <div className="space-y-4">
              ...
              <h3 className="font-semibold text-lg" style={{ fontFamily: 'var(--font-poppins)' }}>4.9/5 Rating</h3>
              <p className="text-gray-600 text-sm" style={{ fontFamily: 'var(--font-inter)' }}>
            ...
            {[
              {
                ...
                description: "Your child chats with Dr. Emma AI in a safe, non-judgmental environment designed specifically for kids.",
                icon: MessageCircle
              },
              {
                step: "2", 
                title: "AI Analysis",
                description: "Advanced AI analyzes conversation patterns, emotions, and mood indicators using child psychology principles.",
                icon: Brain
              },
              {
                step: "3",
                title: "Parent Insights",
                description: "You receive detailed mood reports, concerning pattern alerts, and professional recommendations.",
                icon: TrendingUp
              }
            ].map((item, index) => (
              <div 
              ...
              >
                ...
                <h3 className="text-xl font-semibold text-purple-600 mb-4" style={{ fontFamily: 'var(--font-poppins)' }}>
                  {item.title}
                </h3>
      ...
      <section id="pricing" className="py-20 bg-white">
        <div className="max-w-[1400px] mx-auto px-6">
          ...
          <div className="max-w-lg mx-auto">
            <div className="bg-gradient-to-br from-purple-50 to-blue-50 rounded-2xl border-2 border-purple-200 overflow-hidden shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2">
              ...
              <div className="bg-gradient-to-r from-purple-600 to-blue-600 p-8 text-white text-center">
                <h3 className="text-2xl font-bold mb-2" style={{ fontFamily: 'var(--font-poppins)' }}>
                ...
                <p className="text-purple-100 text-sm mt-2">7-day free trial • Cancel anytime</p>
              </div>
          ...
          <div className="mt-16 max-w-4xl mx-auto">
            <h3 className="text-2xl font-bold text-gray-900 mb-8 text-center" style={{ fontFamily: 'var(--font-poppins)' }}>
              Why One Simple Plan?
            </h3>
            <div className="grid md:grid-cols-2 gap-8">
              <div className="text-center">
                ...
                <h4 className="font-semibold text-gray-900 mb-2" style={{ fontFamily: 'var(--font-poppins)' }}>No Decision Fatigue</h4>
              ...
              <div className="text-center">
                ...
                <h4 className="font-semibold text-gray-900 mb-2" style={{ fontFamily: 'var(--font-poppins)' }}>Complete Family Coverage</h4>
                <p className="text-gray-600" style={{ fontFamily: 'var(--font-inter)' }}>
        ...
        <div className="max-w-[1400px] mx-auto px-6 text-center">
          ...
          <div className="flex items-center justify-center gap-4">
            ...
            <div className="text-left">
              <p className="font-semibold text-gray-900" style={{ fontFamily: 'var(--font-poppins)' }}>Jennifer K.</p>
              <p className="text-gray-500 text-sm" style={{ fontFamily: 'var(--font-inter)' }}>Mother of 2, Family Coach</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="bg-gradient-to-r from-purple-600 to-blue-600 py-20 text-white text-center">
        <div className="max-w-[1400px] mx-auto px-6">
          ...
          <p className="text-xl mb-4 opacity-90" style={{ fontFamily: 'var(--font-inter)' }}>
            Join thousands of families building stronger emotional connections
          </p>
          <p className="text-lg mb-8 opacity-80" style={{ fontFamily: 'var(--font-inter)' }}>
      ...
      <footer className="bg-gray-900 text-white py-12">
        <div className="max-w-[1400px] mx-auto px-6 text-center">
          ...
          <p className="text-gray-400 mb-4" style={{ fontFamily: 'var(--font-inter)' }}>
            Family Communication Coach - Building stronger connections
          </p>
          <p className="text-gray-500 text-sm" style={{ fontFamily: 'var(--font-inter)' }}>
            © 2024 Heart Harbor. All rights reserved. Safe family communication platform.
          </p>
        </div>
      </footer>
    </div>
