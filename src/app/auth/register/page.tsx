...
export default function RegisterPage() {
  ...
  const removeChild = (index: number) => {
    ...
    setFormData({
      ...formData,
      children: newChildren.length > 0 ? newChildren : [{ name: '', age: '', concerns: '' }]
    })
  }
  ...
  const validateStep = (currentStep: number) => {
    ...
    if (currentStep === 1) {
      // Account validation
      if (!formData.parentName.trim()) newErrors.parentName = 'Name is required'
      ...
      formData.children.forEach((child, index) => {
        if (!child.name.trim()) newErrors[`child_${index}_name`] = 'Child name is required'
        if (!child.age.trim()) newErrors[`child_${index}_age`] = 'Age is required'
        ...
        <div className="mb-8">
          <div className="flex items-center justify-center space-x-4 md:space-x-8">
            <div className={`flex items-center space-x-2 ${step >= 1 ? 'text-purple-600' : 'text-gray-400'}`}>
              ...
              <span className="font-medium text-sm md:text-base">Account & Family</span>
            </div>
            ...
            <div className={`flex items-center space-x-2 ${step >= 2 ? 'text-purple-600' : 'text-gray-400'}`}>
              ...
              <span className="font-medium text-sm md:text-base">Payment & Trial</span>
            </div>
            <ArrowRight className="h-4 w-4 text-gray-400" />
          ...
          <div className="lg:col-span-2">
            {step === 1 && (
              <div className="bg-white rounded-xl shadow-sm p-8 border border-gray-100">
                <h2 className="text-2xl font-bold text-gray-900 mb-6">Create Your Account & Family</h2>
                ...
                <div className="space-y-6">
                    ...
                    <div>
                      <div className="flex items-center justify-between mb-4">
                        ...
                        {formData.children.length < 4 && (
                          <button onClick={addChild} className="text-purple-600 hover:text-purple-700 font-medium text-sm">
                            + Add Another Child
                          </button>
                        )}
                      </div>
                        ...
                        {formData.children.map((child, index) => (
                          <div key={index} className="border border-gray-200 rounded-lg p-4">
                            <div className="flex items-center justify-between mb-3">
                              <h5 className="font-medium text-gray-900">Child {index + 1}</h5>
                              {formData.children.length > 1 && (
                                <button onClick={() => removeChild(index)} className="text-red-600 hover:text-red-700 text-sm">
                                  Remove
                                </button>
                              )}
                            </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                              <div>
                                ...
                                />
                                {errors[`child_${index}_name`] && <p className="text-red-600 text-xs mt-1">{errors[`child_${index}_name`]}</p>}
                              </div>
                              ...
                              <div>
                                ...
                                <input
                                  ...
                                  placeholder="Age"
                                />
                                {errors[`child_${index}_age`] && <p className="text-red-600 text-xs mt-1">{errors[`child_${index}_age`]}</p>}
                              </div>
                            </div>
                            ...
                            <div className="mt-3">
                              ...
                              <textarea
                                ...
                                onChange={(e) => updateChild(index, 'concerns', e.target.value)}
                                className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent"
                                rows={2}
                  ...
                  <div className="bg-blue-50 border border-blue-200 rounded-lg p-3 text-sm text-blue-800">
                    ...
                    <p>Next, we'll set up your payment method to start your 7-day free trial.</p>
                  </div>
              ...
              <div className="bg-white rounded-xl shadow-sm p-8 border border-gray-100 text-center">
                ...
                <div className="bg-green-50 border border-green-200 rounded-lg p-4 mb-6">
                  <p className="text-sm text-green-800">
                    ...
                    Your free trial runs for 7 days. You can cancel anytime before it ends.
                  </p>
                </div>
          ...
          <div className="lg:col-span-1">
            <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden sticky top-8">
              <div className="bg-gradient-to-r from-purple-600 to-blue-600 p-6 text-white">
                <h3 className="text-xl font-bold mb-2">Family Communication Coach</h3>
                <div className="flex items-baseline space-x-2">
                  <span className="text-3xl font-bold">$39</span>
                  <span className="text-purple-200">/month</span>
                </div>
                <p className="text-purple-100 text-sm mt-2">Everything your family needs</p>
              </div>
              ...
              <div className="p-6 space-y-4">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">Up to 4 family members</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">Conversation insights & patterns</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-3">
                  <Check className="h-5 w-5 text-green-500 mt-0.5 flex-shrink-0" />
                  <div>
                    <p className="font-medium text-gray-900">Appointment Preparation</p>
                    <p className="text-sm text-gray-600">Organize thoughts for professionals</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-3">
                  <Check className="h-5 w-5 text-green-500 mt-0.5 flex-shrink-0" />
                  <div>
                    <p className="font-medium text-gray-900">24/7 Emotional Support</p>
                    <p className="text-sm text-gray-600">Always available companion</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">Communication growth over time</p>
                  </div>
                </div>
